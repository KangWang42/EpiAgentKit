...
- 论文、报告与汇报以研究者“我做了 X”的视角写作，不使用助手口吻，并采用相应学术书面语；标题使用名词短语，英文缩写首次出现给出全称。正式文字与图内标签只使用来源材料、研究方案或可核验方法文献中的规范术语；不得把内部管理、软件工程或游戏化隐喻写入正式产物，不使用口语化动作、生硬直译、自造缩略语或自造四字短语。术语无法确认时保留原词并先问用户。
