...
SKILL.md 定流程与验收条件；本文件存四个落地模板：run_all.R、包内脚本头部、00_客户说明.md、01_方法与结果.docx 结构。
...
2. 包内脚本头部模板
3. 00_客户说明.md 模板
4. 01_方法与结果.docx 结构与要求（内容强制要求 / 绝对禁止出现 / 结构默认）
...
| 模板化套话（academic-humanizer 审计模式） | 文风失真 | 对照改写并核对不可变事实清单 |
