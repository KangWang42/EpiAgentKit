...
class WorkflowRoutingTests(unittest.TestCase):
    ...
    def test_readme_keeps_statistical_and_writing_boundaries_narrow(self) -> None:
        ...
        self.assertIn("docs/showcase/composites/sysu-ppt.png", body)
        self.assertIn("docs/demo/output/pptx/presentation-preview.pptx", body)
        self.assertIn("docs/demo/output/pptx/presentation-cover.png", body)
        self.assertIn("docs/showcase/composites/academic-ppt.png", body)
        self.assertIn("<summary><strong>sysu-ppt · 中大官方模板学术汇报", body)
        self.assertIn("<summary><strong>academic-ppt · 通用学术汇报", body)
        self.assertGreaterEqual(body.count("<details>"), 7)
