...
def main() -> int:
    ...
    required = {
        ...
        "README.md": (
            ...
            "docs/showcase/composites/sysu-ppt.png",
            "docs/demo/output/pptx/presentation-preview.pptx",
            "docs/demo/output/pptx/presentation-cover.png",
            "docs/demo/output/pptx/presentation-preview.png",
            "docs/demo/output/pptx/presentation-model-results.png",
