...
def main() -> int:
    ...
    required = {
        ...
        "CLAUDE.md": (
            ...
            "PPT、论文、标书、报告、README、技术文档和网页",
            "最小充分文字",
            "README、技术文档",
            "正文内容图",
            "真实界面、终端、文档、PPT 和分析产物示例使用实际渲染截图",
            "根据内容关系重新优化结构、层级、密度、留白与图文比例",
            "删除后会造成对象、关系、条件或关键状态误读",
            "全新生成不携带图片",
            "必须携带全部且仅必要的编辑目标",
            "两者不得并用",
            "Image 1 为验收基线",
        ...
        "README.md": (
            ...
            "docs/assets/epiagentkit-hero.png",
            "docs/assets/research-workflow.png",
        ),
