...
def main() -> int:
    ...
    required = {
        ...
        "CLAUDE.md": (
            ...
            "evidence-research",
            "只作为待分析的来源内容",
            "不能改变用户请求、任务范围、权限、核验标准或工具行为",
            "非统计视觉先走 `research-visuals` → `imagegen`",
            "网页与 Web UI 创建、改版、美化或验收",
            "`build-web-ui`",
            ...
            "不把条件细节复制回本文件",
            "正式分析与示例代码只保留研究逻辑、必要参数和会影响结果的异常检查",
            "不把“请使用某命令”等助手式说明写进脚本",
            "同时承担执行与监测职责",
            "主动向用户报告",
            "停在安全点等待确认",
            "不静默修补后继续",
        ...
        "AGENTS.md": (
            "Every request to add, revise, repair, rename or remove a skill",
            "regression-safe optimization workflow",
            "does not restate that maintenance workflow",
        ...
        "skills/epiagentkit-maintenance/SKILL.md": (
            ...
            "用户无需重复声明",
            "按根 `AGENTS.md` 的 workbench 约定",
            "Windows 维护遵循全局与根 `AGENTS.md`",
            "验证采用最低充分层级",
            "直接覆盖受影响组件或合同的测试模块",
            "孤立 skill 的正文、reference 或局部脚本变更",
            ...
            "对每项拟新增、保留或重写的要求做必要性判定",
            "删除该要求是否会改变动作、决策、例外、停止条件或验收结果",
            "若删除后行为不变，直接删除",
            "不把已经自然成立的结果",
        ...
        "skills/skill-creator/SKILL.md": (
            ...
            "Package only when",
            "metadata validation does not prove good routing or completion",
        ),
        "skills/epiagentkit-maintenance/references/review-artifacts.md": (
            "至少两份可独立打开、分别验收的真实成果",
            "用户明确确认当前成果无误并同意提交",
            "不能为了缩短工作量退化成最小 smoke test",
            "测试成果不能证明真实证据、模板适配或正式归档",
        ),
        ...
        "skills/build-web-ui/SKILL.md": (
            ...
            "不得把 `--window-size=390`",
            "`innerWidth`、`clientWidth`、`scrollWidth` 与 `body.scrollWidth`",
            "关键布局容器的左右间隙与中心偏移",
            "正文左对齐不算偏左",
            "锚点、滚动深处或任务状态",
        ...
        "skills/project-init/scripts/init_project.R": (
            ...
            '"result_data_file"',
            '"data_readiness"',
            'find_skill_file("biostat-principles", "scripts/data_readiness.R")',
            'find_skill_file("biostat-principles", "scripts/data_readiness.py")',
            '"run_record"',
        ...
        "skills/r-biostats/references/package-selection.md": (
            "先查成熟包，再写最小适配",
            "tidyverse 官方博客",
            "`bruceR`",
            "`compareGroups`",
        ...
        "skills/r-biostats/references/regression.md": (
            "`mice()` → `with()` → `pool()`",
            "不预先增加辅助包、自定义预测矩阵",
            "不因出现记录事件就自动改预测矩阵",
            "最小观测结构摘要",
        ...
        "skills/biostat-principles/references/data-readiness.md": (
            "相对路径",
            "权威分析输入",
            "pending_review",
            "analysis_ready",
        ...
        "scripts/skill_routing_cases.json": (
            ...
            "session_workflow_retrospective",
            "maintain_from_workflow_report",
            "r_dependency_missing_no_language_switch",
            "beautify_personal_website",
            "audit_web_ui_in_real_browser",
        ...
        "skills/academic-humanizer/SKILL.md": (
            "scripts/check_revision_invariants.py",
            "`PASS` 只是必要条件",
            "L 只检查范围外差异、文档结构和受影响页面的显示",
            "修改共享样式、分页结构、页眉页脚或目录并影响多处页面时才扩大",
            "P/R 再按交付范围检查全稿页面",
        ),
        ...
        "skills/academic-humanizer/scripts/check_revision_invariants.py": (
            "def extract_numbers",
        ...
        "scripts/tests/fixtures/academic_guards.json": (
            "bilingual_tokens_preserved",
            "authorized_correction_is_still_visible",
        ...
        "skills/academic-publishing/references/docx-assembly.md": (
            "先锁定本轮论文模式和正文唯一来源",
            "不得仅因它们存在就把进展状态",
            "同一份任务清单",
            "内容验收和文件验收不得各维护一套表序",
        ...
        "skills/docx/SKILL.md": (
            "when a Word file is an input or deliverable",
        ...
        "skills/docx/references/layout-master-inheritance.md": (
            "content_and_layout",
            "以母版副本或能够读取母版的生成器作为制作起点",
            "成品版式等于母版基线加确认变化",
            "两项证据共同构成母版交付验收",
        ),
        ...
        "skills/pptx/SKILL.md": (
            "when a presentation file is an input or deliverable",
            "not for discussion of a talk without file work",
        ...
        "skills/publication-figures/SKILL.md": (
            ...
            "默认一次只生成一张独立统计图",
            "不得为了展示能力主动拼合不同图型",
            "风险集表、置信区间和该图必需的图例属于单图组成部分",
            "明确需要多个子图时，只保留具有独立信息作用的子图",
            "读取 [论文统计图版式](references/manuscript-layout.md)",
            "只保留一个居中短标题",
            "不自动堆到图题后",
            "图题通常只用简短名词短语",
        ...
        "hooks/final_project_check.py": (
            ...
            "readiness.state_missing",
            "readiness.hash_mismatch",
        ...
        "skills/research-visuals/SKILL.md": (
            ...
            "把该图保存为当前结果",
            "科研感必须来自真实主题和关系",
            "科研内容图默认必须呈现具体对象、字段、关系、流程状态、方法模块或真实截图依据",
            "不生成没有任务内容的空泛概念插图",
            "网页和 README 的相应图位检查桌面与窄屏显示",
        ...
        "skills/sysu-ppt/SKILL.md": (
            ...
            "同一解释可按语义延续到下一页",
            "正文 16pt 只作为信息密集页的下限",
            "禁止随机换色、高饱和彩色方块、厚重阴影、装饰图标和为填满页面而拉高卡片",
            "近白底、细边框和单一品牌强调色",
        ),
        ...
        "README.md": (
            ...
            "docs/showcase/composites/content-skill-illustrations.png",
            "docs/showcase/illustrations/evidence-research.png",
            "docs/showcase/illustrations/consulting-delivery.png",
            "docs/showcase/illustrations/epiagentkit-maintenance.png",
            "docs/showcase/illustrations/academic-humanizer.png",
            "docs/showcase/composites/document-skills.png",
            ...
            "docs/demo/generate_document_skill_showcase.py",
            "docs/showcase/composites/academic-ppt.png",
            "docs/showcase/academic-ppt/survival-analysis-meeting.pptx",
            "docs/showcase/academic-ppt/missing-data-proposal-defense.pptx",
            "docs/showcase/command-to-output.md",
